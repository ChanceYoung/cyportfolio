...
#### Links:
 ...
 - Create-React-App:   
  ...
  (
    2, ' Testing Javascript using Mocha and Chai','
### The Goal

I have a couple of functions that I want to test in Javascript. In order to do this, I prefer to use a couple different libraries. These libraries are Mocha and Chai. These two libraries work really well together, and will provide us with a good way to unit test some javascript functionality.',`### Installation
